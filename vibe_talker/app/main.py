...
TTS_MODEL = os.getenv("TTS_MODEL", "gpt-4o-mini-tts")  # TTS model env se lo


# def main():  # main entry function (abhi disable hai)
...
if __name__ == "__main__":  # optional entry check
    asyncio.run(speak(text="This is a sample voice. Hi Piyush"))  # sirf TTS test run
